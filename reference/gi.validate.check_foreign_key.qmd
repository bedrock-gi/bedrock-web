...
|------------------------|-----------------------------------------|--------------------------------------------|------------|
| foreign_key            | str                                     | The name of the column of the foreign key. | _required_ |
| parent_table           | Union\[pd.DataFrame, gpd.GeoDataFrame\] | The parent table.                          | _required_ |
| table_with_foreign_key | Union\[pd.DataFrame, gpd.GeoDataFrame\] | The table with the foreign key.            | _required_ |
...
| Name   | Type   | Description                                             |
|--------|--------|---------------------------------------------------------|
| bool   | bool   | True if the foreign keys all exist in the parent table. |
...
| parent_table           | Union\[pd.DataFrame, gpd.GeoDataFrame\] | The parent table containing the primary keys.          | _required_ |
| table_with_foreign_key | Union\[pd.DataFrame, gpd.GeoDataFrame\] | The child table containing the foreign keys.           | _required_ |
